...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-between items-center p-4 shadow-md bg-white dark:bg-gray-800 sticky top-0 z-50 w-full">
      {/* Left side: Logo + Title + Toggle + BackButton */}
      ...
      {/* Right side: (optional, keep empty or add more buttons) */}
      <div></div>
    </nav>
  );
};
