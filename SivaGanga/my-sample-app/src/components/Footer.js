...
export default function Footer() {
    return (
        ...
        <footer className="w-full bg-blue text-white px-6 py-12">

            <div className="flex flex-col md:flex-row items-center justify-center md:justify-between text-center md:text-left text-sm space-y-4 md:space-y-0">
